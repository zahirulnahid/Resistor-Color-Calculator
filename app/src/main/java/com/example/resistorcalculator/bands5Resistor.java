...
public class bands5Resistor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bands5_resistor);
    ...
    void colorSum() {
        TextView result = findViewById(R.id.result);
        String digit;
        digit = "" + colorval1 + colorval2 + colorval3;
